...
function generateIdempotencyKey() {
  ...
  // undefined when the app is served over plain HTTP from an IP address, which
  // would otherwise crash this component on mount. crypto.getRandomValues() has no
  // such restriction, so build a v4 UUID from it manually as a fallback.
